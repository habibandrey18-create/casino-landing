...
const casinosData = [
    // Royal Partners
    { id: 'beef', name: 'Beef Casino', href: 'https://beef-way-one.com/c3a1809ba', categories: ['royal', 'top'], logo: 'https://logo.clearbit.com/beef-way-one.com', badges: ['Royal Partners', '+50 FS по LUDKA'], desc: 'Мощный старт для любителей слотов: до крупного welcome-пакета и фриспины по промокоду LUDKA, плюс быстрые выплаты без лишней бюрократии.' },
    { id: 'martin', name: 'Martin Casino', href: 'https://martin-way-five.com/cb55341ca', categories: ['royal', 'top'], logo: 'https://logo.clearbit.com/martin-way-five.com', badges: ['Royal Partners', '+50 FS по LUDKA'], desc: 'Много турниров и движухи, для тех, кому важен соревновательный азарт: большое приветствие, кэшбэк и постоянные акции для активных игроков.' },
    ...
    { id: 'irwin', name: 'IRWIN Casino', href: 'https://rwn-irrs.com/ccc765ec2', categories: ['royal', 'top'], logo: 'https://logo.clearbit.com/rwn-irrs.com', badges: ['Royal Partners', '+50 FS по LUDKA'], desc: 'Больше про стабильность: бренд давно на рынке, упор на надежность выплат и понятные условия бонусов + фриспины по LUDKA.' },
    ...
    { id: 'sykaaa', name: 'Sykaaa Casino', href: 'https://s-way-q.com/?source=hsjxj&pid=90790', categories: ['other', 'top'], logo: 'https://logo.clearbit.com/s-way-q.com', badges: ['Быстрые выплаты'], desc: 'Быстрые выплаты без задержек, щедрый приветственный бонус и удобный мобильный интерфейс.' },
    // Dragonmoney (только краш-игры)
    { id: 'dragonmoney', name: 'Dragonmoney', href: 'https://dr0.to/ifHOq', categories: ['crash', 'top'], logo: 'https://logo.clearbit.com/dr0.to', badges: ['Краш-игры', 'Промокод: BUPCF'], desc: 'Формат краш и кейсы, быстрый движ и возможность "залететь с промика BUPCF на мини-депозите".' },

    // Казино от котов
    { id: 'gama', name: 'Gama Casino', href: 'https://preesiader.com/sllpxj6el', categories: ['cats', 'top'], logo: 'https://logo.clearbit.com/preesiader.com', badges: ['Надежность'], desc: 'Надежная игровая площадка с лицензией и широким ассортиментом слотов от известных разработчиков, плюс быстрые выводы.' },
    ...
    { id: 'cat', name: 'Cat Casino', href: 'https://catchthecatkz.com/s1d080de5', categories: ['cats', 'top'], logo: 'https://logo.clearbit.com/catchthecatkz.com', badges: ['Уникальный стиль'], desc: 'Милый стиль, но серьёзные призы: уникальные предложения и регулярные акции, включая турниры с крупными джекпотами.' },
